...
/usr/sbin/runuser -l jenkins -c '/usr/bin/java -Djava.awt.headless=true -jar /usr/share/java/jenkins.war --webroot=/var/lib/jenkins/.jenkins/war --logfile=/var/log/jenkins/jenkins.log --httpPort=8080'
